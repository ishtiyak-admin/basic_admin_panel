					...
					<div class="box-body">
						<?php echo e(Form::open(array( "url" => $base_url, "method" => "get", "id"=>"search_form" ))); ?>
							...
							<div class="col-lg-3 col-md-6 col-xs-12">
								...
								<?php echo e(Form::text("username",request()->username,array("class"=>"form-control","placeholder"=>"Username"))); ?>
						...
						<table id="listind_table" class="table table-bordered table-hover datatable cell-border compact stripe hover">
							<thead>
								<tr>
									...
									<th><?php echo sortableColumn($base_url,'username','Username',true); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/recbreaker/resources/views/backend/users/index.blade.php ENDPATH**/ ?>