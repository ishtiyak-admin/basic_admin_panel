	  	...
	  	<div class="modal-dialog modal-dialog-centered" role="document">
		    <div class="modal-content">
		      	...
		      	<div class="modal-body">
		        	<?php echo e(Form::open(array("url" => $base_url.getUrlParams(), "id" => "replyForm", "onsubmit" => '$("#replyModal").find(".submit_btn").attr("disabled","disabled"); $(".loader_container").show();', "enctype" => "multipart/form-data" ))); ?>
		        		...
		        		<div class="form-group">
		        			...
		        			<?php echo e(Form::file("attachment",array( "class" => "mail_attach", "id" => "attachment" ))); ?>
	...
	<script>
		function reply_to_enquiry(id,name,email){
			...
			// if( confirm(confirm_msg) === true ){
				...
				var action = "<?php echo e(url('admin/'.$slug.'/reply')); ?>"+"/"+id+""+getUrlParams;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/recbreaker/resources/views/backend/enquiries/index.blade.php ENDPATH**/ ?>