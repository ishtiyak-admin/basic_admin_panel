			...
			<div class="col-xs-12">
				<div class="box box-primary">
					<div class="box-body">
						...
						<button class="btn btn-primary" data-href="<?php echo e(url('admin').'/'.$slug.'/export/csv'); ?>" onclick="exportExcel(this)" data-confirmAll="Are you sure you want to export all records?" data-confirmselected="Are you sure you want to export selected records?">
					...
					<div class="box-body">
						<?php echo e(Form::open(array( "url" => $base_url, "method" => "get", "id"=>"search_form" ))); ?>
							...
							<div class="col-lg-3 col-md-6 col-xs-12">
								...
								<?php echo e(Form::select("status",[ "all" => "All", "active" => "Active", "deactive" => "Deactive" ],request()->status,array("class"=>"form-control"))); ?>
								...
								<?php if($records->count() > 0): ?>
									<?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										...
										<tr>
											...
											<td>
												<?php echo e(($record['status'] == 1)? 'Active' : 'Deactive'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/recbreaker/resources/views/backend/user/index.blade.php ENDPATH**/ ?>