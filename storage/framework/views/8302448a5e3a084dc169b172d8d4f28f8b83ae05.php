...
?>
	...
	<aside class="main-sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="<?php echo e(( !empty($slug2) && ( $slug2 == 'app_tutorial_screens' ) )? 'active' : ''); ?>">
				<a href="<?php echo e(url('admin/app_tutorial_screens')); ?>">
					<i class="fa fa-list-alt"></i> <span>App Tutorial Screens</span>
				</a>
			</li>
	...
	<div class="content-wrapper">
		...
		</section><?php /**PATH /opt/lampp/htdocs/recbreaker/resources/views/backend/includes/sidebar.blade.php ENDPATH**/ ?>