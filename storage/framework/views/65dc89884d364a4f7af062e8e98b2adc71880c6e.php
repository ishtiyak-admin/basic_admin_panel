								...
								<?php if($records->count() > 0): ?>
									<?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										...
										<tr>
											...
											<td>
												<?php if($record->image): ?>
													<a href="<?php echo e(url('public/uploads/app_tutorial_screens').'/'.$record->image); ?>" data-lightbox="image-1" data-title="<?php echo e($record->name); ?>"><img src="<?php echo e(url('public/uploads/app_tutorial_screens').'/'.$record->image); ?>" style="width:100px;height:100px;" /></a>
												<?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/recbreaker/resources/views/backend/app_tutorial_screens/index.blade.php ENDPATH**/ ?>