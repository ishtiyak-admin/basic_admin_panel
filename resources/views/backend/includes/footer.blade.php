	...
	<!-- /.content-wrapper -->
  	<footer class="main-footer">
		...
		{{ (getSettings('copyright-text'))? getSettings('copyright-text') : "" }}
	</footer>
</div>
<!-- ./wrapper -->
...
@toastr_render
<!-- datatable -->
<script src="{{ url('public/backend/js/dataTables.bootstrap.min.js') }}"></script>
...
<!-- Lightbox -->
<script src="{{ url('public/backend/lightbox2-master/dist/js/lightbox.js') }}"></script>
<!-- jQuery date time picker start -->
<link rel="stylesheet" href="{{ url('public/common/jquery_datetimepicker/build/jquery.datetimepicker.min.css') }}">
<script type="text/javascript" src="{{ url('public/common/jquery_datetimepicker/build/jquery.datetimepicker.full.min.js') }}"></script>
...
<script type="text/javascript" src="{{ url('public/common/jquery_validation/dist/jquery.validate.js') }}"></script>
<script>
